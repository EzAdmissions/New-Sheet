...
export function getUiChrome(settings, theme) {
  ...
  if (style === 'fortnite') {
    return {
      ...
      appBg: dark ? '#061052' : '#0b2b78',
      appBackgroundImage: dark
        ? 'linear-gradient(120deg, rgba(0,98,220,0.62), transparent 38%), linear-gradient(300deg, rgba(0,221,255,0.18), transparent 55%), repeating-linear-gradient(90deg, rgba(255,255,255,0.035) 0 2px, transparent 2px 20px)'
        : 'linear-gradient(120deg, rgba(0,97,219,0.58), transparent 38%), linear-gradient(300deg, rgba(0,221,255,0.2), transparent 55%), repeating-linear-gradient(90deg, rgba(255,255,255,0.04) 0 2px, transparent 2px 20px)',
      toolbarBg: dark ? 'rgba(7,23,91,0.94)' : 'rgba(9,42,130,0.94)',
      toolbarShadow: '0 5px 0 #03133d, 0 18px 36px rgba(0,18,72,0.42)',
      panelBg: dark ? 'rgba(5,18,75,0.94)' : 'rgba(8,40,120,0.92)',
      cardBg: dark ? 'rgba(0,86,199,0.88)' : 'rgba(0,105,220,0.86)',
      inputBg: dark ? '#07124c' : '#e9f5ff',
      border: dark ? '#7ff7ff' : '#7ff7ff',
      borderSubtle: dark ? 'rgba(127,247,255,0.32)' : 'rgba(127,247,255,0.4)',
      radius: 2,
      cardRadius: 3,
      toolbarHeight: 48,
      tabHeight: 37,
      ...
      cardShadow: 'inset 7px 0 0 rgba(127,247,255,0.25), 0 18px 36px rgba(0,18,72,0.34)',
      modalShadow: '10px 10px 0 #0a1030, 0 30px 74px rgba(24,54,160,0.34)',
      tabActiveBg: '#006ee6',
      tabInactiveBg: 'rgba(0,78,168,0.48)',
  ...
  if (style === 'minecraft') {
    return {
      ...
      toolbarBg: dark ? '#303030' : '#7a7a7a',
      toolbarShadow: '0 4px 0 #111111',
      panelBg: dark ? '#2f2f2f' : '#c6c6c6',
      cardBg: dark ? '#3b3b3b' : '#8b8b8b',
      inputBg: dark ? '#191611' : '#fff8e8',
      border: '#1f1f1f',
      borderSubtle: dark ? '#555555' : '#707070',
      radius: 0,
      cardRadius: 0,
      toolbarHeight: 42,
      tabHeight: 34,
  ...
  if (style === 'overwatch') {
    return {
      ...
      appBg: dark ? '#d8dde6' : '#d8dde6',
      appBackgroundImage: dark
        ? 'radial-gradient(circle at 48% 18%, rgba(255,255,255,0.75), transparent 20%), linear-gradient(135deg, rgba(255,203,56,0.2), transparent 32%), linear-gradient(45deg, rgba(108,124,190,0.28), transparent 58%)'
      ...
      toolbarBg: 'rgba(50,61,82,0.92)',
      toolbarShadow: '0 4px 0 #ffc83d, 0 18px 40px rgba(42,64,87,0.2)',
      panelBg: 'rgba(225,231,238,0.82)',
      ...
      tabActiveBg: 'rgba(255,255,255,0.86)',
      tabInactiveBg: 'transparent',
